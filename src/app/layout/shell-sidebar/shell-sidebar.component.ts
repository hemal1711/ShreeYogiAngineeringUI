      ...
      items: [
        {
          ...
          children: [
            ...
            { label: 'Send Receive', icon: 'bi-box-seam', link: '/manufacturing-operations', permissions: ['manufacturingoperation.read'] },
            // { label: 'Production Reports', icon: 'bi-clock-history', link: '/production-reports', permissions: ['productionreport.read'] },
            { label: 'Stock (Party-wise)', icon: 'bi-clipboard-data', link: '/manufacturing-stock', permissions: ['manufacturingoperation.read'] },
            { label: 'Add Item', icon: 'bi-plus-circle', link: '/manufacturing-items/add', permissions: ['manufacturingitem.create'] }
          ]
        }
      ]
    },
